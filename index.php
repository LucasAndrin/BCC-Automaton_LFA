        ...
        <div class="col-md-10 shadow p-3 mb-5 mx-auto card">
            ...
            ?>
                <code class="rounded bg-dark text-white p-5">
                    <code class="text-danger bg-dark rounded p-1">constants</code> <?php var_dump($automaton->getConstant()) ?>
                    <br>
                    <code class="text-warning bg-dark rounded p-1">variables</code> <?php var_dump($automaton->getVariable()) ?>
                    <br>
                    <code class="text-indigo bg-dark rounded p-1">if's</code> <?php var_dump($automaton->getIf()) ?>
                    <br>
                    <code class="text-indigo bg-dark rounded p-1">for's</code> <?php var_dump($automaton->getFor()) ?>
                    <br>
                    <code class="text-indigo bg-dark rounded p-1">while's</code> <?php var_dump($automaton->getWhile()) ?>
                </code>
            <?php
                }
            ?>
